...
generate_claude_md() {
  ...
  if [ ! -f "$src/claude/CLAUDE.template.md" ]; then
    warn "CLAUDE template not found — skipped."
    return
  fi
  cp "$src/claude/CLAUDE.template.md" "$claude_target"
